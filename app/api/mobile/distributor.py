...
def add_product(
    ...
    try:
        ...
        if current_user.get("role") != "super_admin":
            ...
            print(f"DEBUG ADD_PRODUCT: role={current_user.get('role')}, user_id={current_user.get('user_id')}, perms_str={perms_str}, has_permission={has_permission}")
